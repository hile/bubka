...
PATCH_COMMAND_DESCRIPTION = """
Update data partially (patch) with REST API
"""

PATCH_COMMAND_EPILOG = """

"""


class PatchCommand(APICommand):
    """
    Partial update with REST API
    """
    name = 'patch'
    short_description = 'Partial update a record to REST API'
    description = PATCH_COMMAND_DESCRIPTION
    epilog = PATCH_COMMAND_EPILOG
    ...
    def run(self, args):
        ...
        try:
            ...
            self.session.patch(args.url, data, json=jsonformat, debug=args.debug)
